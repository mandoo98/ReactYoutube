...
import { BsYoutube, BsSearch, BsThreeDotsVertical, BsPersonCircle } from "react-icons/bs";
      ...
      <div className='w-full max-w-screen-2xl m-auto'>
        <header className='flex justify-between p-4'>
          ...
          <form onSubmit={handleSubmit} className='flex justify-between border border-zinc-600 rounded-full pl-6 w-1/2 max-w-2xl'>
            ...
            />
            <button className='border-1 border-zinc-600 px-6 bg-zinc-700 rounded-r-full'>
              <BsSearch />
            </button>
          </form>
